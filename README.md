...
3. Ordered Lists: Similar to unordered lis
3.ts, but items have a specific order, like steps in a 
recipe. Enclosed in <li> tags, the list is wrapped in <ol> tags to display numbered steps, 
indicating a clear order.

Definition Lists: Used for key-value pairs, resembling dictionary entries. Each term is 
